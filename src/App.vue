    ...
    <div class="container">
        <div class="left">
          <div class="form-group">
            <label>电子邮箱</label>
            <input type="text" id="user" placeholder="11@qq.com">
          </div>
          <div class="form-group">
            <label>密码</label>
...
export default {
    ...
    methods:{
          ...
          zhuce:function(){
            ...
            console.log()
            this.$http.post("hhttp://localhost:63342/E/register/login.php",{id:user.value,pwd:pwd.value})
            .then((response) => {
              alert('注册成功！');
            // _vm.msg = '注册成功！';
